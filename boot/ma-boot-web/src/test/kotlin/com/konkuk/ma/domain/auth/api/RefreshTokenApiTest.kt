...
import com.konkuk.ma.auth.application.RefreshTokenService
...
class RefreshTokenApiTest(
    ...
    test("리프레시 토큰 재발급 API 문서화") {
        ...
        val loginInfo = LoginInfo(
            ...
            refreshToken = RefreshToken("user@example.com", java.time.LocalDateTime.now().plusDays(7), "new-refresh-token")
        )
