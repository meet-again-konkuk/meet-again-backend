...
@Component
class ShortTextBlockEntityFactory : XroomBlockEntityFactory {
    override val type: XroomBlockType = XroomBlockType.SHORT_TEXT
    override val childTable: LongIdTable = ShortTextBlockTable

    override fun createFrom(row: ResultRow): XroomBlockEntity {
        return ShortTextBlockEntity(
            ...
            content = row[ShortTextBlockTable.content],
        )
    }
}
